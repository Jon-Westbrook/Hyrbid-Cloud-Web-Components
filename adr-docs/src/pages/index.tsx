...
const HomePage = (props: PropsWithChildren<PageProps>) => {
  ...
  return (
    <Layout {...props}>
      <PageTitle
        deck="Welcome to the architecture knowledge base of MIT Widgets. You will find here all the Architecture Decision Records (ADR) of the project."
        preTitle="ADR"
      >
        MIT Widgets&apos;s Architecture Decision Records
      </PageTitle>
      <section
      ...
      >
        ...
        <ul>
          ...
          <li>
            <a href="https://www.github.com/lullabot/gatsby-theme-adr">
              Gatsby Theme ADR
            </a>
          </li>
        </ul>
