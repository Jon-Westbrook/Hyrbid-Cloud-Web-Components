...
<a style={linkButtonStyleSecondary}
   href='https://formatjs.io/docs/getting-started/installation/'
   target='_blank'>React Intl docs</a>
&nbsp;
<a style={linkButtonStyleSecondary} href='https://redux-toolkit.js.org/'
   target='_blank'>Redux Toolkit Docs</a>
