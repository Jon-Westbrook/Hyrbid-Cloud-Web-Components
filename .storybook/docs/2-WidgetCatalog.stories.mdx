...
import workflow from './img/widget-workflow.svg';

<Meta title="Widget Catalog" />
...
consider Storybook to be the best tool for this task, and it is consistent with other IBM teams.
...
Check the [`widget.stories.mdx` file for the Trust Radius widget](https://raw.github.ibm.com/MSC-Cloud/hc-widgets/development/src/apps/trust-radius/widget.stories.mdx)
for an example on how to create one for your new widget.
...
<img width="100%" src={workflow} alt="A diagram of the cycle of a widget into production" />
